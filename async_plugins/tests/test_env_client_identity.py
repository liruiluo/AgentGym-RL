...
class TestSwesmithRewardForwarding(unittest.TestCase):
    ...
    def test_forwards_low_invalid_action_reward(self):
        config = {
            ...
            "checkpoint_contract_penalty": -0.01,
        }
        with mock.patch(
            "agentmemorygym_verl.env_client._client_classes",
    ...
    def test_defaults_checkpoint_contract_penalty_to_zero(self):
        config = {
            "task_name": "swesmith",
            "env_addr": "http://127.0.0.1:65125",
            "max_retries": 0,
        ...
        with mock.patch(
            ...
            create_env_client(config)
        self.assertEqual(
            _RecordingClient.calls[0]["checkpoint_contract_penalty"],
            0.0,
        )

    def test_rejects_positive_or_nonfinite_checkpoint_contract_penalty(self):
