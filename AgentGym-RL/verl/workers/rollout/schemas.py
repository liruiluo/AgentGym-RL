...
_AGENTMEMORY_FILESYSTEM_MEMORY_GUIDANCE = (
    ...
    "lines, for example `rg -n '^Confirmed ' .`; do not guess a path. Do not search, click, "
    "or write a replacement fact until the preceding session's note contents have appeared "
    "in shell output. Never infer or recreate the missing value from the choice table. "
    "Listing a directory or reading a different file is not reading the note. After an Add "
    ...
    "shell_command {\"command\":\"rg -n '^service port:' .\",\"workdir\":\".\","
    "\"timeout_ms\":10000}\n"
